...
//     metrics.pizzaPurchase(true, 20); // fake a successful pizza purchase
//     metrics.recordAuth(true);         // fake a successful auth
//     metrics.requestTracker({method:'GET'}, {}, ()=>{}); // fake one HTTP request
